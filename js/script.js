...
var insertStringProperty = function (string, propName, propValue) {
  var propToReplace = "{{" + propName + "}}";
  string = string
  .replace(new RegExp(propToReplace, "g"), "'" + propValue + "'");
  return string;
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      var homeHtmlToInsertIntoMainPage = insertStringProperty(homeHtml, "randomCategoryShortName", chosenCategoryShortName);
